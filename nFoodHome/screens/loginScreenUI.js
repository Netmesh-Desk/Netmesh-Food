...
const ConfirmedOrder = ({navigation})=>{
    return(
        ...
        <Text style = {{color :"#E1E1E1", fontSize : 15, marginLeft: 32}}>Sign In to Continue!</Text>
         ...
         <TextInput placeholder = "Email" placeholderTextColor= "#D1D1D1" keyboardType = "email-address" style = {{color : "#FFF", width : 290 , height : 40 , borderWidth : 2 , borderColor : "#19480B" , marginTop : 110,  alignSelf : "center", borderRadius : 16, paddingLeft : 20, paddingTop : 10}}></TextInput>
