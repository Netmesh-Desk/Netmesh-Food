...
const ConfirmedOrder = ({navigation})=>{
    return(
        ...
        <Text style = {{color :"#E1E1E1", fontSize : 15, marginLeft: 28}}>Sign Up to get started!</Text>
         <TextInput placeholder = "Name" placeholderTextColor= "#D1D1D1" keyboardType = "name-phone-pad" style = {{color : "#FFF", width : 290 , height : 40 , borderWidth : 2 , borderColor : "#19480B" , marginTop : 100,  alignSelf : "center", borderRadius : 16, paddingLeft : 20, paddingTop : 10}}></TextInput>
         <TextInput placeholder = "Email" placeholderTextColor= "#D1D1D1" keyboardType = "email-address" style = {{color : "#FFF", width : 290 , height : 40 , borderWidth : 2 , borderColor : "#19480B" , marginTop : 40,  alignSelf : "center", borderRadius : 16, paddingLeft : 20, paddingTop : 10}}></TextInput>
         <TextInput placeholder = "Password" placeholderTextColor= "#D1D1D1" keyboardType = "visible-password" secureTextEntry = {true} style = {{color : "#FFF", width : 290 , height : 40 , borderWidth : 2 , borderColor : "#19480B" , marginTop : 40,  alignSelf : "center", borderRadius : 16, paddingLeft : 20, paddingTop : 10}}></TextInput>
